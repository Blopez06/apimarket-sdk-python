...
@dataclass
class ValidarCedulaPostResponseDataItem(AdditionalDataHolder, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> ValidarCedulaPostResponseDataItem:
        if not parse_node:
            raise TypeError("parse_node cannot be null.")
        return ValidarCedulaPostResponseDataItem()
