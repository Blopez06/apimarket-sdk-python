...
if TYPE_CHECKING:
    from .validar_certificado_get_response_data import ValidarCertificadoGetResponseData

@dataclass
class ValidarCertificadoGetResponse(AdditionalDataHolder, Parsable):
    additional_data: Dict[str, Any] = field(default_factory=dict)
    codigo_validacion: Optional[str] = None
    data: Optional[ValidarCertificadoGetResponseData] = None
    message: Optional[str] = None
    status: Optional[int] = None
    success: Optional[bool] = None

    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> ValidarCertificadoGetResponse:
        if not parse_node:
    ...
    def get_field_deserializers(self) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        return {
            ...
            "data":             lambda n: setattr(self, 'data', n.get_object_value(ValidarCertificadoGetResponseData)),
