...
@dataclass
class BuscarNacimiento400Error(APIError):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> BuscarNacimiento400Error:
        if not parse_node:
            raise TypeError("parse_node cannot be null.")
        return BuscarNacimiento400Error()
