...
@dataclass
class BuscarNacimiento5XXError(APIError):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> BuscarNacimiento5XXError:
        if not parse_node:
            raise TypeError("parse_node cannot be null.")
        return BuscarNacimiento5XXError()
