...
@dataclass
class ListarCertificados401Error(APIError):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> ListarCertificados401Error:
        if not parse_node:
            raise TypeError("parse_node cannot be null.")
        return ListarCertificados401Error()
